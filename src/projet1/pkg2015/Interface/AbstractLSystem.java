 ...
 */
package projet1.pkg2015.Interface;
...
public abstract class AbstractLSystem 
{
     ...
     * The action must correspond to one of the methods in {@link ITurtle}: {@link ITurtle#draw() }, {@link ITurtle#move() }, 
     * {@link ITurtle#turnL() }, {@link ITurtle#turnR}, {@link ITurtle#stay}, {@link ITurtle#pop() }, {@link ITurtle#push() }. 
     * 
     ...
     */
    public abstract void tell(ITurtle turtle, Symbol sym);
     ...
     */
    public abstract Rectangle2D tell(ITurtle turtle, Symbol sym, int rounds);
}